...
angular.module('demoAppModule', ['ui.bootstrap']).controller('DemoAppCtrl', function($http, $location, $uibModal) {
    ...
    /** Displays the Forward creation modal. */
    demoApp.openCreateForwardModal = () => {
        const createForwardModal = $uibModal.open({
            templateUrl: 'createForwardModal.html',
            controller: 'CreateForwardModalCtrl',
            controllerAs: 'createForwardModal',
            resolve: {
        ...
        createForwardModal.result.then(() => {}, () => {});
    };
    ...
    /** Displays the Forward transfer modal. */
    ...
    /** Displays the Forward settlement modal. */
    ...
    demoApp.refresh = () => {
        // Update the list of Forwards.
        $http.get(apiBaseURL + "forwards").then((response) => demoApp.forwards =
